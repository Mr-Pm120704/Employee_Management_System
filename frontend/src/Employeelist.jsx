...
function EmployeeList() {
  ...
  const safeSearch = (searchKeyword || "").toLowerCase();

const filteredEmployees = (employees || []).filter(employee =>
  (typeof employee.username === "string" && employee.username.toLowerCase().includes(safeSearch)) ||
  (typeof employee.email === "string" && employee.email.toLowerCase().includes(safeSearch))
);
